...
import com.lithium.blkpnkwall.databinding.MoreLikeThisItemLayoutBinding;
...
public class MoreLikeThisCustomAdapter extends RecyclerView.Adapter<MoreLikeThisCustomAdapter.MyViewHolder> {
    ...
    List<WallpaperItemModel> selectedList;
    String title;
    ...
    public MoreLikeThisCustomAdapter(Activity activity, List<WallpaperItemModel> showItemModels,
                                     List<WallpaperItemModel> selectedList, String title) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(activity).inflate(R.layout.more_like_this_item_layout,
                null, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        WallpaperItemModel singleItem = selectedList.get(position);
